...
public class Controller {
    ...
    @CrossOrigin(origins = "*")
    public String entradaEstoque(@RequestBody EntradaEstoqueDTO entrada) {
        // Atualiza o estoque com a nova quantidade
        servicoEstoque.adicionaAoEstoque(entrada.getCodigoProduto(), entrada.getQuantidade());
        return "Entrada registrada com sucesso para o produto: " + entrada.getCodigoProduto();
    }
